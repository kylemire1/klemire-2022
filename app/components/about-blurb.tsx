  ...
  return (
    <div className="mt-16 grid grid-cols-12 lg:mt-24">
      <div className="col-span-full rounded-lg border border-solid border-primary bg-white py-12 px-12 lg:col-span-7   xl:py-28 xl:px-32">
        <h5 className="mb-8 text-4xl font-semibold leading-snug">
          <span className="block text-highlight">
            Hey there! I'm Kyle Lemire.{" "}
          </span>
          I love to build accessible software with React.{" "}
          <span aria-label="Love">💜</span> <span aria-label="React">⚛️</span>
        </h5>
        <p className="mb-8 leading-relaxed">
          I have been a front end engineer for over 4 years, and in that time I
          have found a passion for the human side of software. I feel most
          at-home when I am teaching another developer a subject I am excited
          about or testing UI components to make sure they are accessible to
